...
public class MovieTest {
	...
	public void testCreateMovie() {
		try {
			Movie a = new Movie("Toy Story (1995)", "01-Jan-1995",
					"http://us.imdb.com/M/title-exact?Toy%20Story%20(1995)", "0001100000000000000");
			...
			Movie mirrorA = new Movie("Toy Story (1995)", "01-Jan-1995",
					"http://us.imdb.com/M/title-exact?Toy%20Story%20(1995)", "0001100000000000000");
	...
	public void testCreateManyMovie() {
		...
		try {
			...
			Movie b = new Movie("GoldenEye (1995)", "01-Jan-1995",
					"http://us.imdb.com/M/title-exact?GoldenEye%20(1995)", "0001100000000000000");
	...
	/**
	 * create a string containing defined character within a defined length
	 * 
	 * @param agent
	 * @param length
	 * @return string
